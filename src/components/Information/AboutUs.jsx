                ...
                <div className="w-full px-4 mb-10 xl:w-1/2 lg:mb-8">
                    <div className="flex flex-wrap">
                        <div className="w-full px-4 md:w-1/2">
                            <img src="https://i.pinimg.com/originals/33/c4/d3/33c4d33e10e6a2417233af66dbb4e820.jpg" alt=""
                                className="object-cover w-full mb-6 rounded-lg h-100" />
                            <img src="https://i.pinimg.com/originals/26/bc/04/26bc0452d4ce207d5f811f77f85e806f.jpg" alt=""
                                className="object-cover w-full rounded-lg h-100" />
                        </div>
                        <div className="w-full px-4 md:w-1/2 xl:mt-11">
                            <img src="https://i.pinimg.com/originals/e5/68/95/e568951eff1835ee44ef6e4d672bd73e.jpg" alt=""
                                className="object-cover w-full mb-6 rounded-lg h-100" />
                            <img src="https://i.pinimg.com/originals/8c/22/a9/8c22a9caa0c96af498458f52315a6e97.jpg" alt=""
                                className="object-cover w-full rounded-lg h-100" />
                        </div>
                    </div>
                </div>
                <div className="w-full px-4 mb-10 xl:w-1/2 lg:mb-8">
                    <div class="px-4 pl-4 mb-6 border-l-2 border-blue-500">
                        <span class="text-sm text-gray-600 uppercase dark:text-gray-400">Who we are?</span>
                        <h1 class="mt-2 font-bold  text-blue-700 md:text-5xl dark:text-gray-300">
                            About Us
                        </h1>
                    </div>
