...
function Contact() {
  ...
  return (
    ...
    <BreadC page = "Contact"/>
      ...
      <section className=" bg-gray-100 font-poppins dark:bg-gray-900 ">
    <div className="justify-center flex-1 max-w-5xl px-4 py-4 mx-auto lg:py-10 md:px-7 container">
        <div className="max-w-xl mx-auto">
            <div className="text-center ">
                <div className="relative flex flex-col items-center">
                    ...
                    <h1 className="text-5xl font-bold dark:text-white"> Our <span className="text-yellow-700"> Contact
                        </span> </h1>
                    <div className="flex w-24 mt-1 mb-10 overflow-hidden rounded">
                        ...
                        <div className="flex-1 h-2 bg-yellow-600">
                        </div>
                    </div>
                </div>
        ...
        <div className="flex flex-wrap mb-8 -mx-4">
            <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                <div
                    ...
                    <div
                        className="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-yellow-500 rounded-full dark:bg-yellow-500">
            ...
            <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                <div
                    ...
                    <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
                        Social</h2>
                    <a href="#"
                        className="inline-block mr-4 text-yellow-600 dark:text-yellow-400 dark:hover:text-yellow-300 hover:text-yellow-700">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a href="#"
                        className="inline-block mr-4 text-yellow-400 dark:text-yellow-400 dark:hover:text-yellow-300 hover:text-yellow-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a href="#"
                        className="inline-block mr-4 text-yellow-500 hover:text-yellow-600 dark:text-yellow-400 dark:hover:text-yellow-300">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div className="px-8 py-8 bg-white border rounded-md shadow-md dark:border-gray-800 dark:bg-gray-800">
            <form action="">
                ...
                <button
                    className="w-full py-4 text-sm font-bold leading-normal text-white transition-all duration-300 bg-yellow-600 rounded-md dark:bg-yellow-500 dark:hover:bg-yellow-600 hover:bg-yellow-700">
                    Send Message
                </button>
            </form>
        </div>
